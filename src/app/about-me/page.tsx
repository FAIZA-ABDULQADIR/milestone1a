    ...
    <div className={style.container}>
      <div className={style.portfolioCard}>
        ...
        <div className={style.section}>
          ...
          <p className={style.paragraph}>
            One day, I was presented with an opportunity that seemed too good to pass up: to study at a <strong>governor’s house</strong>. This was a rare and prestigious opportunity that many would have dreamed of. But there was a catch. The subject I was being offered wasn’t my <em>cup of coffee</em>—<strong>artificial intelligence</strong>. A field dominated by the language of machines, algorithms, and data—everything I had no prior experience with. It felt like I was being asked to dive into an ocean without knowing how to swim.
          </p>
        </div>
        ...
        <div className={style.section}>
          ...
          <p className={style.paragraph}>
            Through sheer determination and a commitment to both my faith and my studies, I became unstoppable. I realized that it’s okay to venture outside of your comfort zone. In fact, sometimes that’s where the magic happens. AI, once foreign and intimidating, became an avenue for me to <strong>serve my community</strong> in ways I never imagined. I began to see how this technology could be aligned with the values I had been taught—<strong>compassion</strong>, <strong>knowledge</strong>, and <strong>service to humanity</strong>.
          </p>
        </div>

        <div className={style.conclusion}>
          <p className={style.conclusionText}>
            Today, I stand at the intersection of technology and tradition. I am no longer just a Muslim girl following a predefined path. I am a woman who is <strong>unwavering</strong> in the pursuit of her dreams, who isn’t afraid to venture into new fields and break barriers. Whether it's AI, Islamic studies, or my volunteer work, each of these paths has helped shape me into the person I am today—strong, resilient, and driven by a sense of purpose.
          </p>
          <p className={style.finalWords}>
            My journey isn’t over. I have so much more to learn, so much more to contribute. But one thing I know for sure: <strong>nothing is impossible if you believe in yourself and stay true to your values.</strong> Today, I am unstoppable—not because I don’t face challenges, but because I’ve learned how to face them with faith, determination, and an open heart. And if I can do it, anyone can. 
          </p>
        </div>
      </div>
    </div>
